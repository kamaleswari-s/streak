                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: '24px', alignItems: 'center' }}>
                    <div style={{ textAlign: 'center' }}>
                      <div style={{
                        fontFamily: 'var(--font-pixel)', fontSize: '22px', color: 'var(--primary)'
                      }}>{formatDuration(s.duration_minutes)}</div>
                      <div style={{ fontSize: '11px', color: 'var(--text-secondary)', opacity: 0.6 }}>duration</div>
                    </div>
                    <div style={{ textAlign: 'center' }}>
                      <div style={{
                        fontFamily: 'var(--font-pixel)', fontSize: '22px', color: 'var(--primary)'
                      }}>{Math.round(s.momentum_score)}</div>
                      <div style={{ fontSize: '11px', color: 'var(--text-secondary)', opacity: 0.6 }}>momentum</div>
                    </div>
                    <div style={{ textAlign: 'center' }}>
                      <div style={{
                        fontFamily: 'var(--font-pixel)', fontSize: '22px', color: 'var(--accent-dark)'
                      }}>{Math.round(s.aura_score)}</div>
